...
CAMERA_SCHEDULER_POLL_SECONDS = float(os.environ.get("CAMERA_SCHEDULER_POLL_SECONDS", 1))
CAMERA_CAPTURE_INTERVAL_SECONDS = int(os.environ.get("CAMERA_CAPTURE_INTERVAL_SECONDS", 30))
CAMERA_MAX_CONCURRENT_CAPTURES = int(os.environ.get("CAMERA_MAX_CONCURRENT_CAPTURES", 4))
