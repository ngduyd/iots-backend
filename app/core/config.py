...
CAMERA_SCHEDULER_POLL_SECONDS = int(os.environ.get("CAMERA_SCHEDULER_POLL_SECONDS", 5))
CAMERA_CAPTURE_INTERVAL_SECONDS = int(os.environ.get("CAMERA_CAPTURE_INTERVAL_SECONDS", 30))
CAMERA_MAX_CONCURRENT_CAPTURES = int(os.environ.get("CAMERA_MAX_CONCURRENT_CAPTURES", 2))
CAMERA_CAPTURE_TASK_TIMEOUT_SECONDS = int(os.environ.get("CAMERA_CAPTURE_TASK_TIMEOUT_SECONDS", 20))
CAMERA_CAPTURE_JITTER_SECONDS = int(os.environ.get("CAMERA_CAPTURE_JITTER_SECONDS", 3))
